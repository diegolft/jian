...
/**
 * Vendored from the Anthropic skills marketplace under Apache-2.0, at the commit below. It
 * ships with the gateway instead of being fetched: a default cannot depend on the network
 * being up when a profile is created, and a pinned copy is the only way to know what every
 * agent of this installation was actually told. See THIRD_PARTY_NOTICES.md.
 */
export const discernmentNudge: Skill = {
  name: 'discernment-nudge',
  description:
    'Use after advice, a draft, an estimate or an analysis the owner may act on: append two or three specific checks.',
  origin: {
    url: 'https://github.com/anthropics/skills/tree/main/skills/discernment-nudge',
    ref: 'f379e5ad66e2febc1616cf8d6284666fecbe514e',
    marketplace: 'Claude',
    importedAt: '2026-09-22T00:00:00.000Z',
  },
  instructions: `# Discernment nudge
